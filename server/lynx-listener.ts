...
export class LynxListener extends EventEmitter {
  ...
  private parseLegacyFieldLine(_line: string, _packet: LynxPacket) {
    // Field data arrives as JSON via the LSS script (T:"F" records).
    // Non-JSON lines on the field port (e.g. stray control bytes) are ignored here.
  }
